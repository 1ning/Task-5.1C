...
public class BlankFragment4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root= inflater.inflate(R.layout.fragment_blank4, container, false);
    ...
    void initnews()
    {
        ...
        List2.add(new1);
        News2 new2= new News2("Ukrainian refugees arrive in Adelaide","More than 100 Ukrainian refugees have arrived in Adelaide, six weeks after the Russian invasion of their homeland began.",R.drawable.a2);
        List2.add(new2);
